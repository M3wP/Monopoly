...
function  ReSIDRead(reSID: Pointer; offset: Integer): Byte; external LIB_RESID;
...
function  ReSIDRead(reSID: Pointer; offset: Integer): Byte; stdcall; external LIB_RESID name '_ReSIDRead@8';
...
function  ReSIDRead(reSID: Pointer; offset: Integer): Byte; stdcall; external LIB_RESID;
